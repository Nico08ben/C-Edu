...
if (isset($_SESSION['user_management_message'])) {
    $message_class = ($_SESSION['user_management_message_type'] === 'success') ? 'alert-success' : 'alert-danger';
    echo '<div class="alert ' . $message_class . '">' . htmlspecialchars($_SESSION['user_management_message']) . '</div>';
    unset($_SESSION['user_management_message']); // Limpiar mensaje para que no se muestre de nuevo
            ...
            <?php if ($resultado->num_rows > 0): ?>
                        <?php while ($fila = $resultado->fetch_assoc()): ?>
                            <tr data-id-usuario="<?= $fila['id_usuario'] ?>"
                                ...
                                <td><img src="assets/images/avatar<?= ($fila['id_usuario'] % 4) + 1 ?>.jpg" alt="Avatar"></td>
