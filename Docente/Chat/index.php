...
<body>
    ...
    <section class="home">
        <section class="chat-section">
            <div class="chat-container">
                <div class="chat-content">
                    ...
                    <div class="conversation" id="conversation-active-chat" style="display: none;">
                        <div class="conversation-top">
                            ...
                            <div class="conversation-buttons">
                                <button type="button" id="view-user-info-btn" title="Ver información del contacto">
        ...
        <script>
            ...
            const DEFAULT_AVATAR_PATH = '<?php echo $webRootForIndex . "Docente/Chat/assets/images/default-avatar.png"; ?>';
        </script>
        ...
        <div id="userInfoModal" class="user-info-modal-overlay" style="display:none;">
            <div class="user-info-modal-content">
                <span class="user-info-modal-close">&times;</span>
                <div id="userInfoModalBody">
                    <div class="user-info-header">
                        <img id="userInfoModalImage" src="" alt="Foto de perfil">
                        <h3 id="userInfoModalName">Cargando...</h3>
                    </div>
                    <div class="user-info-details">
                        <p><strong>Email:</strong> <span id="userInfoModalEmail">...</span></p>
                        <p><strong>Rol:</strong> <span id="userInfoModalRole">...</span></p>
                        <p><strong>Teléfono:</strong> <span id="userInfoModalPhone">...</span></p>
                        <p><strong>Materia:</strong> <span id="userInfoModalSubject">...</span></p>
                    </div>
                </div>
                <div id="userInfoModalLoading" style="display:none; text-align:center; padding: 40px;">
