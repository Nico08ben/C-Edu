                        ...
                        <ul class="content-messages-list">
                            ...
                            <li>
                                <a href="#" data-conversation="#conversation-1">
                                    <img class="content-message-image" src="assets/images/avatar_chat_default.jpg" alt="">
                ...
                <div class="conversation" id="conversation-1">
                    <div class="conversation-top">
                        ...
                        <div class="conversation-user">
                            <img class="conversation-user-image" src="assets/images/avatar_chat_default.jpg" alt="">
                            <div>
                        ...
                        <ul class="conversation-wrapper">
                            ...
                            <li class="conversation-item me">
                                <div class="conversation-item-side">
                                    <img class="conversation-item-image" src="assets/images/avatar_chat_default.jpg" alt="">
                                </div>
