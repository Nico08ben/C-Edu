...
?>
            <div class="admin-controls">
                ...
                <div class="admin-actions"> 
                    <a href="docente_tasks.php?action=create" class="btn-crear-tarea">Crear Nueva Tarea</a>
                </div>
            </div>
    ...
    <script>
        ...
        buttons.forEach(button => {
            button.addEventListener("click", (e) => {
                ...
                setTimeout(() => {
                    ...
                    window.location.href = `docente_tasks.php?action=details&id_tarea=${taskId}`;
                }, 600);
            });
        });
        ...
        filterDropdown.addEventListener("change", (e) => {
            ...
            window.location.href = `docente_tasks.php?filter=${selectedFilter}`;
        });
    </script>